window.onload = function(){
	...
	//menu_item[0].onmouseover = function() {
		//menu_item[0].classList.add("button_menu_hover");
		//menu_item[0].classList.add("button_text_hover");
		//menu_item[0].classList.add("ini_button_class");
		//document.getElementById("ini_icon").style.opacity = '1';
	//};
}